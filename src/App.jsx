      ...
      <main id="main-content" className="pb-16">
              ...
              >
                <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-emerald-200/90">{role.organisation}</p>
                  </div>
                  <p className="text-sm font-medium text-slate-300/90">{role.period}</p>
                </div>
          ...
          <div className="space-y-4 not-prose">
            {sections.education.map((item) => (
              ...
              >
                ...
                <p className="mt-1 text-sm text-slate-200/90">{item.institution}</p>
        ...
        >
          <div className="grid gap-6 not-prose lg:grid-cols-[1.35fr_.95fr]">
            <div>
              <h3 className="mb-3 text-base font-semibold text-white">Core Skills</h3>
          ...
          <div className="space-y-4 not-prose">
            {sections.references.map((item) => (
              ...
              >
                ...
                <p className="mt-2 text-sm text-emerald-200/85">{item.contact}</p>
              </article>
            ))}
          </div>
        </Section>
